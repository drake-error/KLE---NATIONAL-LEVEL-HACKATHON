...
// The replacements mapping slate dark theme to our light design system
const replacements = [
  // Backgrounds
  ...
  // Make the overall page background clean
  { pattern: /bg-surface-container-lowest p-6/g, replacement: 'bg-surface p-6' }
];
